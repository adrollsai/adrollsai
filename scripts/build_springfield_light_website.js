...
async function buildAndSaveWebsite() {
  ...
  const html = generateOptimizedSpringfieldWebsite(properties);
  ...
  console.log('Successfully saved Mobile-Responsive, SEO & LLM-Optimized Springfield Website to landing_pages (ID:', savedPage.id, ')');
}

function generateOptimizedSpringfieldWebsite(properties) {
  const propertiesJson = JSON.stringify(properties).replace(/</g, '\\u003c');

  // Generate JSON-LD Schema for RealEstateAgent & OfferCatalog (for AI/LLM Search & Google Rich Snippets)
    ...
    "@graph": [
      ...
      },
      {
        ...
        "mainEntity": [
          ...
          {
            "@type": "Question",
            "name": "Where is the head office of Bioque Estates located?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Bioque Estates is headquartered at SCO 118-119, Level II, Madhya Marg, Sector 8-C, Chandigarh - 160009. You can schedule private site visits by calling +91 98886 26786."
            }
          },
          {
            "@type": "Question",
            "name": "How far is Omaxe New Chandigarh from PGI and Sector 8 Chandigarh?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Omaxe New Chandigarh is seamlessly connected via the 6-lane Madhya Marg extension, situated just 5 to 7 minutes drive from PGI Chandigarh and Sector 8."
            }
          }
        ]
      }
...
<head>
  ...
  <meta name="description" content="Bioque Estates International delivers premier luxury residences, independent floors, duplex villas, and investment plots across Omaxe New Chandigarh, Chandigarh, Gurugram, and Noida. Direct builder pricing & 100% verified titles.">
  ...
  <meta name="author" content="Bioque Estates International">
  
  <!-- Open Graph / Facebook / WhatsApp Preview -->
  <meta property="og:type" content="website">
  <meta property="og:title" content="Bioque Estates International | Luxury Real Estate & Advisory">
  <meta property="og:description" content="Explore luxury waterfront residences, independent floors, duplex villas, and developer plots in Omaxe New Chandigarh. Direct advisory by Bioque Estates.">
  <meta property="og:image" content="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=85">
  <meta property="og:locale" content="en_IN">
  
  <!-- Twitter Cards -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Bioque Estates International | Luxury Real Estate">
  <meta name="twitter:description" content="Curated Omaxe New Chandigarh properties. Luxury apartments, villas, floors & plots with verified titles.">
  <meta name="twitter:image" content="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=85">
...
<body class="selection:bg-primary-200 selection:text-dark-900 flex flex-col min-h-screen pb-16 md:pb-0">
  ...
  <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-18 sm:h-22">
        
        <!-- LOGO & BRAND -->
        <a href="#home" onclick="navigateTo('home'); return false;" class="flex items-center space-x-3 group">
          <img src="${LOGO_URL}" alt="Bioque Estates Logo" class="h-10 sm:h-12 w-auto object-contain rounded-lg border border-slate-200 p-0.5 bg-white shadow-sm" loading="eager">
          <div>
            <span class="font-display text-lg sm:text-2xl font-extrabold tracking-tight text-dark-900 block leading-tight">BIOQUE ESTATES</span>
            <span class="text-[9px] sm:text-[10px] uppercase tracking-[0.22em] text-primary-600 block font-bold">International Real Estate</span>
          </div>
        </a>
        ...
        <div class="flex items-center space-x-2 sm:space-x-3">
          <a href="https://wa.me/${PHONE_RAW}?text=Hi%20Bioque%20Estates,%20I%20am%20interested%20in%20Omaxe%20New%20Chandigarh%20properties." target="_blank" class="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full border border-emerald-500/50 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 text-xs font-bold transition-all">
            <svg class="w-4 h-4 fill-emerald-600 shrink-0" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg>
            <span>WhatsApp</span>
          </a>
          <button onclick="navigateTo('contact')" class="btn-springfield px-4 py-2 sm:px-5 sm:py-2.5 rounded-full text-xs uppercase tracking-wider font-extrabold flex items-center gap-1.5">
            <span>Schedule Tour</span>
          </button>
          
          <!-- Hamburger button for mobile -->
          <button onclick="toggleMobileMenu()" class="lg:hidden p-2 rounded-xl text-dark-900 hover:bg-slate-100 transition-colors focus:outline-none" aria-label="Toggle navigation menu">
      ...
      <div id="mobile-nav-drawer" class="hidden lg:hidden border-t border-slate-100 py-4 space-y-2 bg-white">
        <a href="#home" onclick="navigateTo('home'); toggleMobileMenu(); return false;" class="block px-4 py-2.5 rounded-xl text-sm font-bold text-dark-900 hover:bg-slate-50">Home</a>
        <a href="#properties" onclick="navigateTo('properties'); toggleMobileMenu(); return false;" class="block px-4 py-2.5 rounded-xl text-sm font-bold text-dark-900 hover:bg-slate-50">Properties Catalog</a>
        <a href="#about" onclick="navigateTo('about'); toggleMobileMenu(); return false;" class="block px-4 py-2.5 rounded-xl text-sm font-bold text-dark-900 hover:bg-slate-50">About Bioque Estates</a>
        <a href="#services" onclick="navigateTo('services'); toggleMobileMenu(); return false;" class="block px-4 py-2.5 rounded-xl text-sm font-bold text-dark-900 hover:bg-slate-50">Services</a>
        <a href="#contact" onclick="navigateTo('contact'); toggleMobileMenu(); return false;" class="block px-4 py-2.5 rounded-xl text-sm font-bold text-dark-900 hover:bg-slate-50">Contact & Site Visits</a>
        <div class="pt-2 px-4 flex items-center gap-2">
          <a href="tel:${PHONE_DISPLAY.replace(/\s+/g, '')}" class="flex-1 btn-springfield text-center py-2.5 rounded-xl text-xs uppercase font-bold">Call ${PHONE_DISPLAY}</a>
        </div>
      </div>
  ...
  <main id="view-home" class="page-view active flex-grow">
    ...
    <!-- HERO SECTION -->
    <section class="relative min-h-[75vh] sm:min-h-[82vh] flex items-center justify-center py-16 sm:py-24 overflow-hidden bg-slate-900">
      <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=2000&q=85" alt="Luxury Real Estate New Chandigarh" class="w-full h-full object-cover object-center brightness-[0.70]" loading="eager">
        <div class="absolute inset-0 bg-gradient-to-t from-black/85 via-black/40 to-black/30"></div>
      </div>

      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/15 backdrop-blur-md border border-white/30 text-white text-[11px] uppercase tracking-[0.2em] font-bold mb-5">
          <span class="w-2 h-2 rounded-full bg-primary-400"></span>
          <span>New Chandigarh • Official Omaxe Portfolio</span>
        </div>

        <h1 class="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-5 leading-tight max-w-5xl mx-auto">
          Find Your Luxury Home in <br class="hidden sm:block"/><span class="text-primary-300">New Chandigarh</span>
        </h1>

        <p class="text-slate-200 text-sm sm:text-base md:text-lg max-w-3xl mx-auto mb-8 leading-relaxed font-normal">
          Exclusive collection of waterfront residences, designer independent floors, luxury duplex villas, and developer plots by Bioque Estates International.
        </p>

        <!-- SPRINGFIELD CLEAN TABBED SEARCH BOX -->
        <div class="max-w-4xl mx-auto bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-2xl text-left border border-slate-100">
          
          <div class="flex items-center space-x-2 border-b border-slate-100 pb-3 mb-3 overflow-x-auto text-xs font-bold uppercase tracking-wider">
            <button onclick="setHomeFilter('All')" class="home-filter-tab active px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-dark-900 text-white transition-all" data-type="All">All</button>
            <button onclick="setHomeFilter('Residential')" class="home-filter-tab px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all" data-type="Residential">Apartments</button>
            <button onclick="setHomeFilter('Villas')" class="home-filter-tab px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all" data-type="Villas">Villas</button>
            <button onclick="setHomeFilter('Independent Floors')" class="home-filter-tab px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all" data-type="Independent Floors">Floors</button>
            <button onclick="setHomeFilter('Plots')" class="home-filter-tab px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all" data-type="Plots">Plots</button>
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 items-center">
            <div class="sm:col-span-5">
              <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1 ml-1">Search Project</label>
              <input type="text" id="home-search-input" placeholder="e.g. The Lake, Mulberry Villas, Ambrosia..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900 focus:bg-white transition-all">
            </div>

            <div class="sm:col-span-4">
              <label class="block text-[10px] font-bold uppercase tracking-wider text-slate-500 mb-1 ml-1">Budget Range</label>
              <select id="home-budget-select" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-dark-900 focus:outline-none focus:border-dark-900 focus:bg-white transition-all">
            ...
            <div class="sm:col-span-3 pt-1 sm:pt-4">
              <button onclick="executeHomeSearch()" class="btn-springfield w-full py-3 rounded-xl text-xs uppercase tracking-wider font-extrabold flex items-center justify-center gap-2 shadow-md">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-center">
          <div class="p-3 sm:p-4 rounded-2xl bg-slate-50 border border-slate-100">
            <span class="font-display text-2xl sm:text-3xl font-extrabold text-dark-900 block mb-0.5">10+</span>
            <span class="text-[11px] sm:text-xs uppercase tracking-wider text-slate-500 font-bold">Years Experience</span>
          </div>
          <div class="p-3 sm:p-4 rounded-2xl bg-slate-50 border border-slate-100">
            <span class="font-display text-2xl sm:text-3xl font-extrabold text-dark-900 block mb-0.5">13+</span>
            <span class="text-[11px] sm:text-xs uppercase tracking-wider text-slate-500 font-bold">Omaxe Projects</span>
          </div>
          <div class="p-3 sm:p-4 rounded-2xl bg-slate-50 border border-slate-100">
            <span class="font-display text-2xl sm:text-3xl font-extrabold text-dark-900 block mb-0.5">100%</span>
            <span class="text-[11px] sm:text-xs uppercase tracking-wider text-slate-500 font-bold">Verified Titles</span>
          </div>
          <div class="p-3 sm:p-4 rounded-2xl bg-slate-50 border border-slate-100">
            <span class="font-display text-2xl sm:text-3xl font-extrabold text-dark-900 block mb-0.5">0%</span>
            <span class="text-[11px] sm:text-xs uppercase tracking-wider text-slate-500 font-bold">Brokerage on New Units</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 sm:py-20 bg-[#F8F9FA] relative">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
          <div>
            <span class="text-primary-600 text-xs uppercase tracking-[0.25em] font-bold block mb-1.5">Prime Real Estate</span>
            <h2 class="font-display text-2xl sm:text-4xl font-extrabold text-dark-900 tracking-tight">
              Featured Properties in New Chandigarh
            </h2>
          </div>
          <button onclick="navigateTo('properties')" class="btn-outline px-5 py-2 rounded-full text-xs uppercase tracking-wider font-bold flex items-center gap-1.5">
            <span>View All Properties</span>
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
          </button>
        </div>

        <div id="home-properties-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
    ...
    <section class="py-16 sm:py-20 bg-white border-t border-slate-100 relative">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 items-center">
          
          <div class="lg:col-span-5 relative">
            <div class="relative rounded-3xl overflow-hidden shadow-xl border border-slate-100">
              <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85" alt="Bioque Estates Luxury Properties" class="w-full h-[380px] sm:h-[480px] object-cover" loading="lazy">
            </div>
            
            <div class="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-4 bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xl max-w-[260px] sm:max-w-xs">
          ...
          <div class="lg:col-span-7">
            ...
            <h2 class="font-display text-2xl sm:text-4xl font-extrabold text-dark-900 mb-4 sm:mb-6 leading-tight">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div class="p-4 sm:p-5 rounded-2xl bg-slate-50 border border-slate-100">
                <div class="w-8 h-8 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center mb-2.5">
  ...
  <!-- ========================================================================= -->
  <main id="view-properties" class="page-view flex-grow py-12 sm:py-14 bg-[#F8F9FA]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="border-b border-slate-200 pb-5 mb-6">
        ...
        <p class="text-slate-500 text-xs sm:text-sm mt-1">Live listings, pricing, and configurations directly synced with our database.</p>
      </div>

      <!-- Filters & Sorting Bar -->
      <div class="bg-white border border-slate-200 rounded-2xl p-3 sm:p-4 mb-8 flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3 shadow-sm">
        
        <div class="flex items-center space-x-1.5 sm:space-x-2 overflow-x-auto text-[11px] sm:text-xs font-bold uppercase tracking-wider pb-1 md:pb-0">
          <button onclick="setCatalogFilter('All')" class="catalog-filter-btn active px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-dark-900 text-white transition-all shrink-0" data-type="All">All (<span id="count-all">10</span>)</button>
          <button onclick="setCatalogFilter('Residential')" class="catalog-filter-btn px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all shrink-0" data-type="Residential">Apartments</button>
          <button onclick="setCatalogFilter('Villas')" class="catalog-filter-btn px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all shrink-0" data-type="Villas">Villas</button>
          <button onclick="setCatalogFilter('Independent Floors')" class="catalog-filter-btn px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all shrink-0" data-type="Independent Floors">Floors</button>
          <button onclick="setCatalogFilter('Plots')" class="catalog-filter-btn px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-slate-600 hover:text-dark-900 transition-all shrink-0" data-type="Plots">Plots</button>
        </div>

        <div class="relative w-full md:w-64">
          <input type="text" id="catalog-search-input" oninput="filterCatalog()" placeholder="Search project name..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900 focus:bg-white">
        </div>

      </div>

      <div id="catalog-properties-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        <!-- Injected via JavaScript -->
      </div>
  ...
  <!-- ========================================================================= -->
  <main id="view-property-detail" class="page-view flex-grow py-10 sm:py-12 bg-[#F8F9FA]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10">
        ...
        <div class="lg:col-span-8 space-y-6 sm:space-y-8">
          ...
          <div class="rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 shadow-md relative aspect-[16/10] bg-slate-100">
            <img id="detail-main-image" src="" alt="Property" class="w-full h-full object-cover" loading="eager">
            <div class="absolute top-3 left-3 sm:top-4 sm:left-4 flex gap-2">
              <span id="detail-type-badge" class="bg-white/90 backdrop-blur text-dark-900 text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full shadow-sm">Residential</span>
              <span id="detail-status-badge" class="bg-emerald-600 text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full shadow-sm">Ready to Move</span>
            </div>
            <div class="absolute bottom-3 left-3 sm:bottom-4 sm:left-4">
              <span id="detail-price-badge" class="bg-dark-900 text-white font-extrabold text-sm sm:text-lg px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-xl shadow-lg"></span>
            </div>
          </div>

          <!-- Thumbnail Strip -->
          <div id="detail-thumbnails-strip" class="flex gap-2.5 overflow-x-auto pb-2">
            <!-- Injected by JS -->
          </div>

          <!-- Project Title & Address -->
          <div class="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200 shadow-sm">
            <h1 id="detail-title" class="font-display text-2xl sm:text-3xl lg:text-4xl font-extrabold text-dark-900 mb-2"></h1>
          ...
          <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
            <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-3">Project Overview</h3>
            <p id="detail-description" class="text-slate-600 text-xs sm:text-sm leading-relaxed font-normal whitespace-pre-line"></p>
          </div>

          <!-- Configurations -->
          <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
            <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-4">Unit Configurations & Sizes</h3>
          ...
          <!-- Amenities -->
          <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
            <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-4">Features & Amenities</h3>
        ...
        <div class="lg:col-span-4">
          <div class="sticky top-24 space-y-6">
            ...
            <div class="bg-white p-5 sm:p-7 rounded-2xl border border-slate-200 shadow-md">
              <span class="text-primary-700 text-[10px] uppercase tracking-widest font-bold block mb-1">Direct Developer Pricing</span>
              <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-1.5">Request Floor Plans & Price Sheet</h3>
              <p class="text-slate-500 text-xs mb-5">Receive full brochure, unit layout drawings, and payment schedule directly.</p>

              <form onsubmit="handleDetailInquiry(event)" class="space-y-3.5">
                <div>
                  <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">Your Full Name *</label>
                  <input type="text" id="detail-lead-name" required placeholder="e.g. Rajiv Kumar" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900 focus:bg-white">
                </div>

                <div>
                  <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">WhatsApp Phone Number *</label>
                  <input type="tel" id="detail-lead-phone" required placeholder="+91 98886 26786" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900 focus:bg-white">
                </div>

                <div>
                  <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">Preferred Unit Size</label>
                  <select id="detail-lead-unit" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 focus:outline-none focus:border-dark-900 focus:bg-white">
                ...
                <button type="submit" id="detail-submit-btn" class="btn-springfield w-full py-3 rounded-xl text-xs uppercase tracking-widest font-extrabold flex items-center justify-center gap-2 shadow-sm">
              ...
              <div class="mt-5 pt-5 border-t border-slate-100 text-center">
                <a id="detail-whatsapp-btn" href="#" target="_blank" class="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl border border-emerald-500/50 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 text-xs font-bold transition-all">
            ...
            <div class="bg-white p-5 rounded-2xl border border-slate-200 text-center shadow-sm">
              ...
              <a href="tel:${PHONE_DISPLAY.replace(/\s+/g, '')}" class="text-dark-900 hover:text-primary-600 font-extrabold text-base transition-colors">${PHONE_DISPLAY}</a>
            </div>
  ...
  <!-- ========================================================================= -->
  <main id="view-about" class="page-view flex-grow py-14 sm:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      
      <div class="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        <span class="text-primary-600 text-xs uppercase tracking-[0.25em] font-bold block mb-2">About Bioque Estates</span>
        <h1 class="font-display text-2xl sm:text-4xl lg:text-5xl font-extrabold text-dark-900 tracking-tight mb-3">
          Redefining Real Estate Excellence
        </h1>
        <p class="text-slate-500 text-xs sm:text-sm leading-relaxed">Built on uncompromising credibility, transparency, and top-tier service across Tri-City, Gurugram, and Noida.</p>
      </div>

      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-16">
        <div class="space-y-4 sm:space-y-5 text-slate-600 text-xs sm:text-base leading-relaxed">
          <p>
        ...
        <div class="relative rounded-3xl overflow-hidden border border-slate-200 shadow-xl">
          <img src="https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1200&q=85" alt="Bioque Estates Advisory" class="w-full h-[320px] sm:h-[420px] object-cover" loading="lazy">
        </div>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
        <div class="p-6 sm:p-8 rounded-3xl bg-slate-50 border border-slate-100 text-center">
          <div class="w-12 h-12 rounded-2xl bg-primary-100 text-primary-700 flex items-center justify-center mx-auto mb-3.5">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
          </div>
          <h3 class="font-display text-base sm:text-lg font-bold text-dark-900 mb-1.5">Unwavering Credibility</h3>
        ...
        <div class="p-8 rounded-3xl bg-slate-50 border border-slate-100 text-center">
          ...
          <h3 class="font-display text-base sm:text-lg font-bold text-dark-900 mb-1.5">Absolute Transparency</h3>
        ...
        <div class="p-8 rounded-3xl bg-slate-50 border border-slate-100 text-center">
          ...
          <h3 class="font-display text-base sm:text-lg font-bold text-dark-900 mb-1.5">End-to-End Advisory</h3>
  ...
  <!-- ========================================================================= -->
  <main id="view-services" class="page-view flex-grow py-14 sm:py-16 bg-[#F8F9FA]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        ...
        <p class="text-slate-500 text-xs sm:text-sm">Comprehensive advisory tailored for high-net-worth families, end-users, and NRI investors.</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        
        <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
          <div class="w-12 h-12 rounded-2xl bg-primary-100 text-primary-700 flex items-center justify-center mb-5">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
          </div>
          <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-2">Residential Property Sales</h3>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-2">Developer Plots & Land Advisory</h3>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
          ...
          <h3 class="font-display text-lg sm:text-xl font-bold text-dark-900 mb-2">NRI Property Portfolio Desk</h3>
  ...
  <!-- ========================================================================= -->
  <!-- PAGE VIEW 6: CONTACT US & CRM VISIT SCHEDULER -->
  <!-- ========================================================================= -->
  <main id="view-contact" class="page-view flex-grow py-14 sm:py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        ...
        <p class="text-slate-500 text-xs sm:text-sm">Our luxury property consultants are at your service for private tours and customized portfolio reviews.</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12">
        ...
        <div class="lg:col-span-5 space-y-4 sm:space-y-6">
          ...
          <div class="p-5 sm:p-6 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <div class="flex items-start space-x-3.5">
              ...
              <div>
                ...
                <p class="text-slate-500 text-xs mt-1">
                  <a href="tel:${PHONE_DISPLAY.replace(/\s+/g, '')}" class="hover:text-primary-600 transition-colors font-bold text-sm text-dark-900">${PHONE_DISPLAY}</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <!-- Contact & CRM Form -->
        <div class="lg:col-span-7 bg-slate-50 p-6 sm:p-10 rounded-3xl border border-slate-200 shadow-sm">
          <h3 class="font-display text-xl sm:text-2xl font-bold text-dark-900 mb-1.5">Schedule A Private Site Tour</h3>
          <p class="text-slate-500 text-xs mb-6">Experience New Chandigarh projects firsthand with personal walkthroughs.</p>

          <form onsubmit="handleGeneralInquiry(event)" class="space-y-3.5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">Full Name *</label>
                <input type="text" id="contact-name" required placeholder="e.g. Rajiv Kumar" class="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900">
              </div>
              <div>
                <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">WhatsApp Phone *</label>
                <input type="tel" id="contact-phone" required placeholder="${PHONE_DISPLAY}" class="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900">
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div>
                ...
                <select id="contact-project" class="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 focus:outline-none focus:border-dark-900">
              ...
              <div>
                ...
                <input type="text" id="contact-datetime" placeholder="e.g. Tomorrow at 3:00 PM" class="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900">
              </div>
            </div>

            <div>
              <label class="block text-[11px] font-bold text-slate-700 uppercase tracking-wider mb-1">Special Requirements (Optional)</label>
              <textarea id="contact-message" rows="3" placeholder="Tell us about preferred facing, floor preference, or immediate possession requirement..." class="w-full bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs text-dark-900 placeholder-slate-400 focus:outline-none focus:border-dark-900"></textarea>
            </div>
  ...
  <!-- MOBILE STICKY BOTTOM ACTION BAR (HIGH CONVERSION) -->
  <div class="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-4 py-2.5 flex items-center justify-between gap-2 shadow-lg">
    <a href="tel:${PHONE_DISPLAY.replace(/\s+/g, '')}" class="flex-1 btn-outline py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5">
      <svg class="w-3.5 h-3.5 text-dark-900" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
      <span>Call</span>
    </a>
    <a href="https://wa.me/${PHONE_RAW}?text=Hi%20Bioque%20Estates,%20I%20am%20interested%20in%20Omaxe%20New%20Chandigarh%20properties." target="_blank" class="flex-1 py-2 rounded-xl border border-emerald-500/50 bg-emerald-50 text-emerald-700 text-xs font-bold flex items-center justify-center gap-1.5">
      <svg class="w-3.5 h-3.5 fill-emerald-600" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z"/></svg>
      <span>WhatsApp</span>
    </a>
    <button onclick="navigateTo('contact')" class="flex-1 btn-springfield py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1">
      <span>Book Tour</span>
    </button>
  </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-center gap-6 border-b border-slate-100 pb-8 mb-8">
        <div class="flex items-center space-x-3">
          <img src="${LOGO_URL}" alt="Bioque Logo" class="h-10 w-auto object-contain rounded border border-slate-200 p-0.5 bg-white" loading="lazy">
          <div>
        ...
        <div class="flex flex-wrap gap-5 sm:gap-6 text-xs uppercase tracking-wider font-bold text-slate-600 justify-center">
          <a href="#home" onclick="navigateTo('home'); return false;" class="hover:text-dark-900">Home</a>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4 text-slate-400">
        <p>© 2026 Bioque Estates International. All rights reserved. Registered Office: SCO 118-119, Level II, Madhya Marg, Sector 8-C, Chandigarh. Phone: ${PHONE_DISPLAY}</p>
  ...
  <!-- ========================================================================= -->
  <!-- JAVASCRIPT: CONTROLLER & CRM SYNC -->
  <!-- ========================================================================= -->
  <script>
      ...
      return \`
        <article class="springfield-card overflow-hidden flex flex-col h-full group">
          <div class="relative aspect-[16/10] overflow-hidden bg-slate-100">
            ...
            <span class="absolute bottom-3 left-3 bg-dark-900 text-white font-extrabold text-xs px-3 py-1.5 rounded-xl shadow-md">
              \${p.price || 'Price on Request'}
            </span>
          </div>

          <div class="p-5 sm:p-6 flex-1 flex flex-col">
            <h3 class="font-display font-extrabold text-dark-900 text-lg sm:text-xl mb-1 group-hover:text-primary-700 transition-colors">\${p.title}</h3>
            
            <div class="text-xs text-primary-700 font-bold mb-2.5 tracking-wide">\${unitsDisplay}</div>
            ...
            <div class="pt-3.5 border-t border-slate-100 flex items-center gap-2 mt-auto">
    ...
    function renderPropertyDetail(propId) {
      ...
      thumbsContainer.innerHTML = allImgs.map((thumbUrl) => \`
        <button onclick="document.getElementById('detail-main-image').src='\${thumbUrl}'" class="w-16 h-12 sm:w-20 sm:h-14 rounded-xl overflow-hidden border border-slate-200 hover:border-dark-900 shrink-0 transition-all">
      ...
      unitsContainer.innerHTML = units.map(u => \`
        <div class="flex items-center space-x-2.5 sm:space-x-3 p-3 sm:p-3.5 rounded-xl bg-slate-50 border border-slate-100">
    ...
    async function syncLiveInventory() {
      try {
        ...
        console.log('Live sync fallback active');
      }
    }
