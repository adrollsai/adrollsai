...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'call_logs' AND policyname = 'Users can view call logs in their org or own logs'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'call_logs' AND policyname = 'Users can insert their own call logs'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE tablename = 'call_logs' AND policyname = 'Users can update their own call logs'
    ) THEN
