        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Our Content:</strong> The AdRollsAI code, design, templates, and algorithms are the intellectual property of RAHUL CHOPRA and are protected by copyright laws.</li>
            </ul>
          </section>
