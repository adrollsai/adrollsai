      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section className="border-t border-slate-800 pt-8 mt-8">
            ...
            <p>For any questions regarding these Terms, please contact us at: <a href="mailto:info@nobogent.com" className="text-amber-500 hover:underline">info@nobogent.com</a> or by phone at <a href="tel:+919872669935" className="text-amber-500 hover:underline">+91-98726 69935</a></p>
          </section>
        </div>
      </div>
    </div>
