        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>"Company," "We," "Us," or "Our"</strong> refers to ADROLLS AI.</li>
              <li><strong>"Service"</strong> refers to the AdRollsAI application and website which provides marketing automation, image branding, and ad management for real estate professionals.</li>
          ...
          <section>
            ...
            <p className="mb-2">AdRollsAI provides tools to automate real estate marketing. By using our Service, you acknowledge and agree that:</p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            ...
            <p className="mb-2">Our Service relies heavily on APIs provided by Meta (Facebook and Instagram). By using AdRollsAI, you explicitly acknowledge:</p>
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Account Bans:</strong> You are responsible for keeping your Facebook Ad Account and Business Page in good standing. AdRollsAI is not liable if your ad account is restricted, banned, or disabled by Meta due to policy violations.</li>
              <li><strong>Permission Revocation:</strong> If you revoke the permissions granted to AdRollsAI via Facebook Settings, our Service will stop functioning.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>AdRollsAI Rights:</strong> We reserve the right to refuse to process or publish content that we determine is illegal, offensive, or in violation of Meta’s advertising policies.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Ad Budget Distinction:</strong> <span className="text-amber-500 font-bold">IMPORTANT:</span> Fees paid to AdRollsAI are for the use of the software only. The budget for running ads (Ad Spend) is paid directly to Facebook/Meta through your connected Ad Account. We do not handle, hold, or refund your Facebook ad budget.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li><strong>Our Content:</strong> The AdRollsAI code, design, templates, and algorithms are the intellectual property of ADROLLS AI and are protected by copyright laws.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4">7. Limitation of Liability</h2>
            <p className="mb-2">To the maximum extent permitted by applicable law, ADROLLS AI shall not be liable for:</p>
            <ul className="list-disc pl-5 space-y-2">
