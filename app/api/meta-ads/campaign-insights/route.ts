...
export async function GET(request: Request) {
    ...
    try {
        const res = await fetch(`https://graph.facebook.com/v19.0/${campaignId}/insights?fields=impressions,clicks,spend,actions&date_preset=maximum&access_token=${profile.facebook_token}`)
