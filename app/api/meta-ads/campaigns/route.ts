...
export async function GET(request: Request) {
  ...
  try {
    ...
    const fbUrl = `${FB_GRAPH_URL}/${targetProfile.ad_account_id}/campaigns?fields=id,name,status,effective_status,objective,start_time,created_time&limit=100&access_token=${token}`;
