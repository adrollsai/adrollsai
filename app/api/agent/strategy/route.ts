...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `
      ...
      Provide distinct variations in the lighting, mood, color palette, setting, and layouts adhering strictly to the Category target described above.
      
      For each variation, provide:
      1. Title (The name of the visual style variation, e.g. "Sunset Luxury Glow", "Minimalist White Studio", etc.)
