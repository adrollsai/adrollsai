...
export default function AssetsPage() {
  ...
  // 4. Handle WhatsApp Share (DIRECT INTENT)
  const handleShareWhatsApp = () => {
    ...
    if (isMobile) {
        // This direct intent bypasses the browser page and the share sheet, taking them straight to WhatsApp
        window.location.href = `whatsapp://send?text=${encodedText}`
    } else {
        // Fallback for desktop Web app
