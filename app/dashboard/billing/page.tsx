                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20 items-stretch">
                    {pricingTiers.map((tier) => {
                        ...
                        return (
                            <div
                                key={tier.id}
                                className={`bg-white rounded-[2rem] border overflow-hidden flex flex-col justify-between hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 relative ${tier.highlight
