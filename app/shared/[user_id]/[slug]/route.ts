        ...
        if (finalHtml.match(prodContainerRegex) || slug === 'index') {
            ...
            if (profile.business_landing_show_products !== false) {
                ...
                if (propertiesData && propertiesData.length > 0) {
                    ...
                    if (isDarkTheme) {
                        productsHtml = `
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-8" style="font-family: inherit;">
                                ${propertiesData.map(p => {
                                    ...
                                    <div class="rounded-3xl overflow-hidden glass-card flex flex-col h-full group" style="box-sizing: border-box; display: flex; flex-direction: column;">
                                        ...
                                        <div class="p-6 flex-1 flex flex-col" style="padding: 1.5rem; display: flex; flex-direction: column; flex-grow: 1;">
                                            ...
                                            ${p.address ? `
                                                <div class="flex items-center gap-1.5 text-slate-500 text-xs mb-5" style="display: flex; align-items: center; gap: 0.375rem; color: #64748b; font-size: 0.75rem; margin-bottom: 1.25rem;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 14px; height: 14px; shrink-0;"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
            ...
            } else if (!finalHtml.includes('LIVE_PROPERTIES') && !finalHtml.includes('home-properties-grid') && finalHtml.includes('</body>')) {
