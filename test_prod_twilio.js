...
async function run() {
  console.log("Checking Vercel Prod MASTER_TWILIO_SID:", process.env.MASTER_TWILIO_SID);
  console.log("Checking Vercel Prod MASTER_TWILIO_TOKEN:", process.env.MASTER_TWILIO_TOKEN);
