...
async function testTextButtonMessage() {
  ...
  // Method A: Interactive Text + Reply Button
  console.log("Sending Interactive Text + Connect with Expert button payload to " + testPhone + "...");
  const payload = {
